...
-- CreateEnum
CREATE TYPE "UnitType" AS ENUM ('UNIDAD', 'LIBRA', 'KILO', 'CAJA', 'DOCENA');

-- CreateEnum
CREATE TYPE "ReferenceType" AS ENUM ('inputs', 'outputs');
...
CREATE TABLE "pointsOfSale" (
    ...
    CONSTRAINT "pointsOfSale_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "prices" (
    ...
    "discountType" "DiscountType" NOT NULL DEFAULT 'MONTO',
    "active" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "pointsOfSale" ADD CONSTRAINT "pointsOfSale_branchId_fkey" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_pointSaleId_fkey" FOREIGN KEY ("pointSaleId") REFERENCES "pointsOfSale"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES "staffs"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;
